"""
roadGrid.py: Python class that handles uniform grid placement for our sliding windows implementation and provides
...
class RoadGrid:
    """
     Class for helping us map the road surface using voxel for quick 3D reconstruction
    """
