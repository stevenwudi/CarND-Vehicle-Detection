#!/usr/bin/python
"""
Python class that manages two lines in the array that forms a lane, keeps measurements and confidence calculations
and operations at the lane level.
This class is also the starting point for the efficient vehicle detection and tracking classes
(vehicles should only be on the road...)
There is a shared array of lanes instances - we are tracking multiple lanes!
"""
...
class Lane:
    def __init__(self, x, y, projectedX, projectedY, lines, left=0, right=1, maskvalue=128):
        # initial setup
        self.curFrame = None
